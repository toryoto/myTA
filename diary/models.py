...
class Reviewer(models.Model):
    diary_owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name='granted_reviewers')
    reviewer = models.ForeignKey(User, on_delete=models.CASCADE, related_name='review_permissions')
